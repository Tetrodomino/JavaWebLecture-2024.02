...
<head>
	...
	<script>
		function search() {
			const field = $('#field').val(); // id가 field인 태그의 입력값(val)
					...
					<tr>
						<td style="width: 52%; text-align: left">
							<h3><strong class="me-5">게시글 목록</strong>
								<span style="font-size: 16px;"><a href="/jw/bbs/board/insert"><i class="fa-solid fa-pen-to-square"></i> 글 쓰기</a>
								</span>
							</h3>
						</td>
						<td style="width: 16%;">
						...
						<c:if test="${empty query }">
							<input type="text" class="form-control" placeholder="검색할 내용" id="query">						
						</c:if>
