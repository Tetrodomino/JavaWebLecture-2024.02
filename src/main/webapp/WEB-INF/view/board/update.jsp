...
<body>
	...
	<div class="container" style="margin-top:80px">
    	<div class="row">
			...
			<!-- //// 본문 영역 //// -->
			<div class="col-9">
				<h3><strong class="me-5">게시글 수정</strong>
				</h3>
       			<hr>
		       	<div class="col-1"></div>
		       	<div class="col-10">
		       	<form action="/jw/bbs/board/update?bid=${board.bid}&uid=${board.uid}" method="post">
					<table class="table table-borderless">
					<tr>
						<td style="width: 10%;"><label class="col-form-label">제목</label></td>
						<td style="width: 90%;"><input type="text" name="title" class="form-control" value="${board.title }"></td>
					</tr>
					<tr>
