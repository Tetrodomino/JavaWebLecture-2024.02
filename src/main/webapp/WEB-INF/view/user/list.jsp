...
<head>
	...
	<script>
		function deleteFunc(uid) {
			$('#deleteUid').val(uid); // id값이 deleteUid인 곳의 value를 uid로 설정
    	...
    	<div class="row">
			...
			<div class="col-9">
				<h3><strong class="me-5">사용자 목록</strong>
					<span style="font-size: 16px;"><a href="/jw/bbs/user/register"><i class="fa-solid fa-user"></i> 사용자 가입</a>
					</span>
				</h3>
       			<hr>
       			<div class="row">
								...
								<tr>
									...
									<td>
										...
										<c:if test="${user.uid ne sessUid}">
											<a class="disabled-link" href="#"><i class="fa-solid fa-user-pen"></i></a>
										</c:if>
